...
void roundrobin()
{
  ...
  printf("\nPROCESS NAME\tBURST TIME (ms)\tCOMPLETION TIME (ms)\tWAITING TIME (ms)\tTURNAROUND TIME (ms)\n\n");
  for(i=0;i<n;i++)
  {
    printf("    %s\t\t\t%d\t\t\t%d\t\t\t%d\t\t\t%d\n",p[i].name,p[i].bt,p[i].ct,p[i].wt,p[i].tt);
    avwt+=p[i].wt;
    avtt+=p[i].tt;
  }
  printf("\n\nGANTT CHART ");
...
void priority()
{
  ...
  printf("\nPROCESS NAME\tBURST TIME (ms)\tPRIORITY TIME (ms)\tCOMPLETION TIME (ms)\tWAITING TIME (ms)\tTURNAROUND TIME (ms)\n\n");
  for(i=0;i<n;i++)
  {
    printf("    %s\t\t\t%d\t\t\t%d\t\t\t%d\t\t\t%d\t\t\t%d\n",p[i].name,p[i].bt,p[i].pr,p[i].ct,p[i].wt,p[i].tt);
    twt+=p[i].wt;
    ttt+=p[i].tt;
  }
  printf("\n\nGANTT CHART ");
